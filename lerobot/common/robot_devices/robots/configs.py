...
class KochRobotConfig(ManipulatorRobotConfig):
    ...
    dh_params = [
        ...
        {"theta": 0, "d": 0, "a": 0.10935, "alpha": np.pi},
        {"theta": 0, "d": 0, "a": 0.10051, "alpha": 0},
        {"theta": -np.pi/2, "d": 0, "a": 0, "alpha": -np.pi/2},
        {"theta": 0, "d": 0.05815, "a": 0, "alpha": 0},
    ]

    d_positions = [[ 0.195,-0.0809, 8.8293],[0.1988, -0.0415,  8.2231],[0.1983, -0.0006,  6.3474],[0.1989, 0.0388,  4.407],[0.2004, 0.0805, 2.3005],
    ...
    '''
    d_positions = [[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],
                   [-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],
                   [0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],
                   [-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],[0.0338, 0.1231, 6.6873],[-0.0393, 0.0523, 5.1431],
